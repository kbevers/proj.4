...
INSERT INTO "metadata" VALUES('NKG.DATE', '2020-11-04');
...
VALUES(
    'NKG','ETRF2000_TO_NKG_ETRF00', -- operation auth+code
    'ETRF2000 to NKG_ETRF00',       -- name
    NULL,                           -- description
...
INSERT INTO "usage" VALUES (
    ...
    'NKG','ETRF2000_TO_NKG_ETRF00', -- object auth+code
    'NKG','EXTENT_2008',    -- extent auth+code
    'NKG','SCOPE_GENERIC'   -- scope auth+code
);
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_NKG_ETRF00', 2, 'EPSG', '7941'), -- ITRF2000 -> ETF2000
    ('NKG', 'ITRF2000_TO_NKG_ETRF00', 3, 'NKG', 'ETRF2000_TO_NKG_ETRF00')
;
...
VALUES(
    'NKG','ETRF2014_TO_NKG_ETRF14', -- operation auth+code
    'ETRF2014 to NKG_ETRF14',       -- name
    NULL,                           -- description
    'PROJ', 'PROJString',           -- method auth+code
...
INSERT INTO "usage" VALUES (
    ...
    'other_transformation', -- object_table_name
    'NKG','ETRF2014_TO_NKG_ETRF14', -- object auth+code
    'NKG','EXTENT_2020',    -- extent auth+code
    'NKG','SCOPE_GENERIC'   -- scope auth+code
);
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_NKG_ETRF14', 2, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_NKG_ETRF14', 3, 'NKG', 'ETRF2014_TO_NKG_ETRF14')
;
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF00 to ETRF92, epoch kept at 2000.0', -- description / remark
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF00 to ETRF96, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF00', -- source auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF00 to ETRF89, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF00', -- source auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF00 to ETRF2000, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF00', -- source auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF00 to ETRF93, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF00', -- source auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF00 to ETRF97, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF00', -- source auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF14 to ETRF92, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF14 to ETRF96, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF14', -- source auth+code
    'EPSG','7926',  -- target auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF14 to ETRF89, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF14', -- source auth+code
    'EPSG','7914',  -- target auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF14 to ETRF2000, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF14', -- source auth+code
    'EPSG','7930',  -- target auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF14 to ETRF93, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF14', -- source auth+code
    'EPSG','7922',  -- target auth+code
...
INSERT INTO "helmert_transformation" VALUES (
    ...
    'Transformation between NKG_ETRF14 to ETRF97, epoch kept at 2000.0', -- description / remark
    'EPSG','1033',  -- method auth+code
    'Position Vector transformation (geocentric domain)',
    'NKG','ETRF14', -- source auth+code
    'EPSG','7928',  -- target auth+code
...
INSERT INTO "concatenated_operation" VALUES(
    ...
    'Transformation from NKG_ETRF00@2000 to ETF92@1994.704', -- description
    'NKG', 'ETRF00',-- source_crs:  NKG_ETRF00
    'EPSG','4936',  -- target_crs:  ETRS89 (DK)
    0.05,           -- accuracy
    'NKG 2008',     -- operation_version
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_DK', 1, 'EPSG', '7941'), -- ITRF2000 -> ETF2000
    ('NKG', 'ITRF2000_TO_DK', 2, 'NKG', 'ETRF2000_TO_NKG_ETRF00'),
...
INSERT INTO "concatenated_operation" VALUES(
    ...
    'Transformation from NKG_ETRF00@2000 to ETF96@1997.56', -- description
    'NKG', 'ETRF00',-- source_crs:  NKG_ETRF00
    'EPSG','4936',  -- target_crs:  ETRS89 (EE)
    0.05,           -- accuracy
    'NKG 2008',     -- operation_version
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_EE', 1, 'EPSG', '7941'), -- ITRF2000 -> ETF2000
    ('NKG', 'ITRF2000_TO_EE', 2, 'NKG', 'ETRF2000_TO_NKG_ETRF00'),
...
INSERT INTO "concatenated_operation" VALUES(
    ...
    'Transformation from NKG_ETRF00@2000 to ETF96@1997', -- description
    'NKG', 'ETRF00',-- source_crs:  NKG_ETRF00
    'EPSG','4936',  -- target_crs:  ETRS89 (FI)
    0.05,           -- accuracy
    'NKG 2008',     -- operation_version
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_FI', 1, 'EPSG', '7941'), -- ITRF2000 -> ETF2000
    ('NKG', 'ITRF2000_TO_FI', 2, 'NKG', 'ETRF2000_TO_NKG_ETRF00'),
...
INSERT INTO "concatenated_operation" VALUES(
    ...
    'Transformation from NKG_ETRF00@2000 to ETF89@1992.75', -- description
    'NKG', 'ETRF00',-- source_crs:  NKG_ETRF00
    'EPSG','4936',  -- target_crs:  ETRS89 (LV)
    0.05,           -- accuracy
    'NKG 2008',     -- operation_version
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_LV', 1, 'EPSG', '7941'), -- ITRF2000 -> ETF2000
    ('NKG', 'ITRF2000_TO_LV', 2, 'NKG', 'ETRF2000_TO_NKG_ETRF00'),
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_LT', 2, 'NKG', 'ETRF2000_TO_NKG_ETRF00'),
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_NO', 2, 'NKG', 'ETRF2000_TO_NKG_ETRF00'),
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2000_TO_SE', 2, 'NKG', 'ETRF2000_TO_NKG_ETRF00'),
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_DK', 1, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_DK', 2, 'NKG', 'ETRF2014_TO_NKG_ETRF14'),
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_EE', 1, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_EE', 2, 'NKG', 'ETRF2014_TO_NKG_ETRF14'),
...
INSERT INTO "concatenated_operation" VALUES(
    ...
    'NKG_ETRF00 to ETRS89(FI)', -- name
    'Transformation from NKG_ETRF00@2000 to ETF96@1997.0', -- description
    'NKG', 'ETRF14',-- source_crs:  NKG_ETRF00
    'EPSG','4936',  -- target_crs:  ETRS89 (FI)
    0.05,           -- accuracy
    'NKG 2020',     -- operation_version
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_FI', 1, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_FI', 2, 'NKG', 'ETRF2014_TO_NKG_ETRF14'),
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_LV', 1, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_LV', 2, 'NKG', 'ETRF2014_TO_NKG_ETRF14'),
...
INSERT INTO "concatenated_operation" VALUES(
    ...
    'NKG_ETRF00 to ETRS89(LT)', -- name
    'Transformation from NKG_ETRF00@2000 to ETF2000@2003.75', -- description
    'NKG', 'ETRF14',-- source_crs:  NKG_ETRF00
    'EPSG','4936',  -- target_crs:  ETRS89 (LT)
    0.05,           -- accuracy
    'NKG 2020',     -- operation_version
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_LT', 1, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_LT', 2, 'NKG', 'ETRF2014_TO_NKG_ETRF14'),
...
INSERT INTO "concatenated_operation" VALUES(
    ...
    'NKG_ETRF00 to ETRS89(NO)', -- name
    'Transformation from NKG_ETRF00@2000 to ETF93@1995.0', -- description
    'NKG', 'ETRF14',-- source_crs:  NKG_ETRF00
    'EPSG','4936',  -- target_crs:  ETRS89 (NO)
    0.05,           -- accuracy
    'NKG 2020',     -- operation_version
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_NO', 1, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_NO', 2, 'NKG', 'ETRF2014_TO_NKG_ETRF14'),
    ('NKG', 'ITRF2014_TO_NO', 3, 'NKG', 'PAR_2020_NO'),
...
INSERT INTO "concatenated_operation_step" (
    ...
    ('NKG', 'ITRF2014_TO_SE', 1, 'EPSG', '8366'), -- ITRF2014 -> ETF2014
    ('NKG', 'ITRF2014_TO_SE', 2, 'NKG', 'ETRF2014_TO_NKG_ETRF14'),
